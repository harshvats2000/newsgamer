...
export const UPDATING_SCORE_SUCCESS = "UPDATING_SCORE_SUCCESS";
export const UPDATING_SCORE_FAIL = "UPDATING_SCORE_FAIL";

export const FETCHING_GAME_CHATS_SUCCESS = "FETCHING_GAME_CHATS_SUCCESS";
